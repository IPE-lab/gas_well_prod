...
for i in range(30, len(training_set_scaled) - 5):
    x_train.append(training_set_scaled[i - 30:i, 0:6])
    y_train.append(training_set_scaled[i:i+5, 2])
...
for i in range(30, (len(test_set_scaled) - 5), 5):
    x_test.append(test_set_scaled[i - 30:i, 0:6])
    y_test.append(test_set_scaled[i:i+5, 2])
...
history = model.fit(x_train, y_train, batch_size=32, epochs=170, validation_data=(x_test, y_test), verbose=2,
                    shuffle=False)
model.summary()
model.save("./my_model/LSTM_model_30_5.h5")
...
print("mse is")
print(mse_1_v,mse_2_v,mse_3_v,mse_4_v,mse_5_v)
...
print("r2 is")
print(r_2_1,r_2_2,r_2_3,r_2_4,r_2_5)
